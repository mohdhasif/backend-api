' VBScript to run Prayer Cron with subscription-based duplicate prevention
...
' Main loop
Do
    ' Run the prayer cron script with subscription-based duplicate prevention
    command = "php """ & scriptPath & "\cron_prayer_push_subscription_fixed.php"" >> """ & logFile & """ 2>&1"
